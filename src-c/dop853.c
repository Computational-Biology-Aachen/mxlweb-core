/* dop853.f -- translated by f2c (version 20200916).
...
/*      (minor modification on AUGUST 4, 2025) */
...
/* -------- NRDENS   NUMBER OF DENSE OUTPUT COMPONENTS */
	...
	if (nrdens > 0 && *iout < 2) {
		...
		s_wsle(&io___14);
		do_lio(&c__9, &c__1, " WARNING: PUT IOUT=2 OR IOUT=3 FOR DEN"
			"SE OUTPUT ", (ftnlen)48);
		e_wsle();
	    }
	}
	...
	integer *naccpt, integer *nrejct)
{
    ...
    integer iord;
    logical last;
    doublereal erri, hnew, bspl, facc1, facc2, xout, expo1, hlamb, ydiff, 
	    atoli;
    integer iasti;
    ...
    static cilist io___78 = { 0, 0, 0, fmt_979, 0 };
